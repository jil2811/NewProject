...
<?php
$id=$_GET['id'];
$fetch_contact_about="SELECT * FROM contact WHERE id='$id'";
$contact_result=mysqli_query($con,$fetch_contact_about);
$content=mysqli_fetch_assoc($contact_result);
if(isset($_POST['contact'])){
	...
	if(empty($title) || empty($content)){
		...
		$update_about_sql="UPDATE contact SET title='$title',content='$content' WHERE id='$id'";
          	...
          	?>
				...
				<form action="" method="post">
					...
					<div class="text-right">
						...
						<input type="submit" name="contact" class="btn btn-success" value="Edit Content">
					</div>
				</form>
			</div>
          </section>
